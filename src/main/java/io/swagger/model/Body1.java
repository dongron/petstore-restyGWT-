...
@XmlEnumValue("available") AVAILABLE(String.valueOf("available")), @XmlEnumValue("pending") PENDING(String.valueOf("pending")), @XmlEnumValue("sold") SOLD(String.valueOf("sold"));
  ...
  **/
  ...
  public Body1 category(PetCategory category) {
    this.category = category;
    return this;
  }
  ...
  **/
  ...
  public Body1 photoUrls(List<String> photoUrls) {
    this.photoUrls = photoUrls;
    return this;
  }

  public Body1 addPhotoUrlsItem(String photoUrlsItem) {
  ...
  **/
  ...
  public Body1 tags(List<PetTags> tags) {
    this.tags = tags;
    return this;
  }

  public Body1 addTagsItem(PetTags tagsItem) {
  ...
  **/
  ...
  public Body1 status(StatusEnum status) {
    this.status = status;
    return this;
  }
